...
//Routers:
const abilityRouter = require(`./abilities/ability-router`)
...
const classFocusRouter = require(`./class-focuses/focus-router`)
const firstNameRouter = require(`./firstNames/fname-router`)
const genderRouter = require('./genders/genders-router')
const languageRouter = require(`./languages/languages-router`)
const lastNameRouter = require(`./lastNames/lnames-router`)
...
server.use(cors())
server.use(`/api/ability`, abilityRouter)
server.use(`/api/alignment`, alignRouter)
server.use(`/api/auth`, authRouter)
server.use(`/api/background`, backgroundRouter)
server.use(`/api/class`, classRouter)
server.use(`/api/class-focus`, classFocusRouter)
server.use(`/api/firstname`, firstNameRouter)
server.use(`/api/gender`, genderRouter)
server.use(`/api/language`, languageRouter)
server.use(`/api/lastname`, lastNameRouter)
